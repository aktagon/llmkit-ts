...
// Models / ScopedModels / Providers classes (generated in builders/catalogue.ts)
// and the hand-coded runtime in models.ts / providers.ts.
...
/** Compiled-in catalogue, sorted by (provider, id). Walked by Models.list() and Models.get(id). */
 ...
 *  never carries. Unknown pairs return undefined. */
